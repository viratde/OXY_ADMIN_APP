package com.oxyhotels.manager.feature_booking.presentation.screens
...
import com.oxyhotels.admin.feature_booking.presentation.composables.CompleteDatePicker
    ...
    Scaffold(
        ...
        Screen(
            ...
            CompleteDatePicker(
                ...
                onDateChange ={
                    bookingStoreViewModel.updateDate(it)
                }
            )

            AnimatedVisibility(visible = state.value.isCompleteLoading) {
            ...
            LazyColumn(
                ...
                item {
                    Column {
                        ...
                        if(state.value.completeBookings.isEmpty()){
                            Column(
                        ...
                        state.value.completeBookings.map {
                            BookingInfo(
                                bookingModel = it,
                                onClick = {
