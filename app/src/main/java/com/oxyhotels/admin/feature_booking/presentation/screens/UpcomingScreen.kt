...
fun UpcomingScreen(
    ...
    Scaffold(
        ...
        Screen(
            ...
            AnimatedVisibility(visible = state.value.isUpcomingLoading) {
            ...
            LazyColumn(
                ...
                item {
                    ...
                    if (state.value.upcomingBookings.isEmpty()) {
                        Column(
                            modifier = Modifier
                                .fillMaxWidth()
                                .height(500.dp),
                    ...
                    Column {
                        state.value.upcomingBookings.sortedBy {
                            format.parse(it.checkInTime)
                        }.map {
                            BookingInfo(
                                bookingModel = it,
                                onClick = {
